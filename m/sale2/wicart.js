...
function WICard(obj, plugins) {
  ...
  this.reCalc = function() {
    ...
    // *** //
    this.widjetObj.html(local.goods + ' ' + num + '<br/>' + local.amount + ' ' +
        sum + ' Руб.');
    localStorage.setItem(this.cardID, JSON.stringify(this.DATA));
  };
  ...
  this.renderBasketTable = function() {
    ...
    if ($('#bcontainer').length == 0) {
      $('body').append(' \
				...
				<div id=\'bfooter\'><button class=\'bbutton\' onclick="cart.showWinow(\'order\', 1)">' +
          local.order + '</button><b> ИТОГО: </b><span id=\'bsum\'>...</span></div> \
      ...
      with (this.DATA[idkey]) {
        var productLine = '<div class="card_body"> \
										<div class="table"> \
											<div class="row"> \
												...
												<div class="col cell_info c100" style="vertical-align:top; text-align:left;"> \
													<b>' + name + '</b> \
													</br>Цена: <span id="lineprice_' + id +
            '"class="wigoodprice">' + price + '</span> руб. \
													<div class="col" style="vertical-align:top; width:20px; text-align:center;"><a id="minus_' +
            ...
            id + '" style="font-size: 16px;">' + num + '</span></b></center></div> \
													<div class="col" style="vertical-align:top; width:20px; text-align:center;"><a id="plus_' +
            id + '"><img src="icons/icon-plus.png" width="25"/></a></div> \
												</div> \
												<div class="col cell_info" style="vertical-align:top; width: 30px; text-align:center;"><a href="#" onclick="' +
